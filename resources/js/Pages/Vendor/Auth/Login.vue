            ...
            <section class="flex w-full items-center justify-center px-6 pb-10 sm:px-10 lg:w-[44%] lg:justify-end lg:px-14 lg:py-14 xl:px-20">
                <div class="card-in relative w-full max-w-md">
                    ...
                    <div class="relative overflow-hidden rounded-[26px] border border-white/60 bg-white/95 p-7 shadow-2xl shadow-emerald-950/40 backdrop-blur-xl sm:p-9">
                        ...
                        <div class="mb-7">
                            <h2 class="text-2xl font-black tracking-tight text-slate-900">Vendor sign in</h2>
                            <p class="mt-1.5 text-sm font-medium text-slate-500">
                                Sign in to your Link Portal vendor account.
                            </p>
                        </div>
                        ...
                        <div class="mt-7 flex items-center justify-center gap-1.5 rounded-xl border border-slate-100 bg-slate-50 px-4 py-3 text-xs text-slate-500">
                            ...
                            <Link :href="route('login')" class="font-bold text-emerald-700 transition hover:text-emerald-900">Sign in here</Link>
                        </div>
                    </div>
                </div>
            </section>
